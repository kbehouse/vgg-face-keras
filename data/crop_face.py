...
faceCascade = cv2.CascadeClassifier("../faceDB/haarcascade_frontalface_default.xml")

FacesDir = 'faces/'
TrainDir = 'train/'
ValidationDir = 'validation/'
OnePerson_TrainMax = 30   # you can remove 2 by manual
OnePerson_ValidMax = 20   # you can remove 2 by manual
